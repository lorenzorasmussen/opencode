...
---
description: Intelligent debugging workflow with AI-assisted error analysis, systematic root cause investigation, automated fix suggestions, reproduction case generation, and comprehensive issue tracking
agent: debug_specialist
subagent: architect, tester
argument-hint: "[error|file] [--analyze] [--fix] [--trace] [--reproduce] [--ai]"
---
```
