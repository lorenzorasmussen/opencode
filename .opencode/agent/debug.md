...
**Objective:** Capture error, classify severity, gather context
...
**Objective:** Use AI to analyze error patterns and suggest root causes
...
Integration: AI-assisted analysis + Traditional debugging tools
...
class AIDebugAnalyzer:
    ...
    def __init__(self, session_dir: Path):
        ...
        self.model = "local-llm"  # Configurable local model
...
**Objective:** Apply scientific debugging methodology
...
Approach: Scientific Method + 5-Whys Analysis
...
Apply scientific debugging method:
...
**Objective:** Generate and apply fixes automatically
...
**Objective:** Create minimal reproduction test case
...
This `/debug` command provides comprehensive debugging workflows with AI-assisted analysis, systematic methodologies, automated fix generation, and reproduction case creation.
